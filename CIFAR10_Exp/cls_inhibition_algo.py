...
'''
  "LateralInhibition" class has been taken from the Paper "Lateral Inhibition-Inspired Convolutional Neural Network for Visual Attention and Saliency Detection (2018)"
   with minor changes
'''
