...
class Hyperparametr:
    ...
    def dataGeneration(self,n_experiences):
        ...
        scenario_trainVal = PermutedMNIST(n_experiences=n_experiences,eval_transform=test_transformInput)
    ...
    def objective(self,trial):
        ...
        params = {
            "ewc_lambda": trial.suggest_float("ewc_lambda",500,1e4,step = 1e3),
...
def main():
    ...
    study.optimize(StableAccuracyPerConfig, n_trials=11)#
