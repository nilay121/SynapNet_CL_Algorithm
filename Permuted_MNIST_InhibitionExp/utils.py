...
class utility_funcs:
    ...
    def barPlotMeanPred(y_plotPlastic,y_plotStable,y_clsOutput,stdStablePred,stdPlasticPred,stdClsOutput,n_experinces):
        ...
        ax.set_title("Permutted MNIST")
        ax.set_xlabel("Experiences & Models")
        ax.set_ylabel("Accuarcy")
        ax.set_xticks(ind+width,["exp1","exp2","exp3","exp4","exp5","Avg CLS Output"])
    ...
    def ConfusionMatrixPerExp(predictionsForCF_stable, predictionsForCF_plastic, ground_truth, labels, exp_numb, n_experiences):
        ...
        #plt.show()
        #plt.savefig(f"confusionMatrix/confusionMatrix{exp_numb}experience_WithIL10Times.png")