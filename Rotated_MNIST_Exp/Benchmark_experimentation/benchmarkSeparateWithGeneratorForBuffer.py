...
def main():
    ...
    learning_rateGR = 1e-4#0.001
    batch_sizeGR = 32 #32 #128
    num_epochsGR = 15
    ...
    for counter in range(num_runs):
        ...
        eval_mb_size=eval_batch_size, ewc_lambda=ewc_lambda, criterion=CrossEntropyLoss(), train_epochs=8, device=device)
        #lambda=0.001
...
def barPlotMeanPred(meanBenchEWC,meanBenchLWF,meanBenchSI,meanBenchNaive,meanBenchJoint,stdBenchEWC,stdBenchLWF,stdBenchSI,stdBenchNaive,stdBenchJoint,n_experinces):
    ...
    ax.set_title("Rotated MNIST Benchmark")
