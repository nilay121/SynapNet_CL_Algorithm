...
class Hyperparametr:
    ...
    def dataGeneration(self,n_experiences):
        ...
        scenario_trainVal = RotatedMNIST(n_experiences=n_experiences,eval_transform=test_transformInput)
    ...
    def objective(self,trial):
        ...
        params = {
            "ewc_lambda": trial.suggest_float("ewc_lambda",500,10000,step = 1000),
...
def main():
    ...
    study.optimize(StableAccuracyPerConfig, n_trials=10)#
